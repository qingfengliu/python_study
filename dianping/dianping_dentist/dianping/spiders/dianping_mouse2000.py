...
class Dianping_Mouse(scrapy.Spider):
    ...
    name = 'dianping_mouse2000_spider'

    def start_requests(self):
        data = db.query("select DISTINCT city_name,city_id,district_name,district_id from t_hh_dianping_business_area WHERE city_id>2000")
        for item in data:
            page = 1
