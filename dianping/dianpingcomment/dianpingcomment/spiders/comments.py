...
db = web.database(dbn='mysql', db='pet_cloud', user='xxxx', pw='xxxx', port=3306, host='xxxx')
...
class DianpingtuanSpider(scrapy.Spider):
    ...
    def start_requests(self):
        data = db.query(
            'SELECT distinct dianping_id FROM hospital_base_information WHERE dianping_id is not null and dianping_id!=0 and dianping_id="20698577";')
        for d in data:
